/**
 * 关于页面组件 - 展示个人简介、技能专长和理念
 * 包含个人头像、统计数据、技能进度条和理念展示
 * 数据从数据库读取，可在后台管理中编辑
 */
...
export default function About() {
  ...
  const [intro, setIntro] = useState('我是一名充满激情的全栈开发者，致力于创造优雅、高效、令人惊叹的数字体验。代码不仅是工具，更是一种艺术表达。');
  ...
  /**
   * 渲染函数 - 返回关于页面的主要JSX结构
   * 包含粒子背景、导航栏、个人简介、统计数据、技能展示和理念展示
   */
  return (
